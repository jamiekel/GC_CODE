...
! End INLINED RCONST
  ...
  RCONST(404) = (GCARR(8.0E-11,0.0E+00,0.0))
  RCONST(405) = (GCARR(1.2E-10,0.0E+00,0.0))
  RCONST(406) = (GCARR(1.1E-10,0.0E+00,0.0))
  RCONST(407) = (GCARR(5.0E-11,0.0E+00,0.0))
  RCONST(408) = (GCARR(5.0E-11,0.0E+00,0.0))
  RCONST(409) = (GCARR(5.0E-11,0.0E+00,0.0))
  RCONST(410) = (GCARR(5.0E-11,0.0E+00,0.0))
  RCONST(411) = (GCARR(5.0E-11,0.0E+00,0.0))
  RCONST(412) = (GCARR(5.0E-11,0.0E+00,0.0))
  RCONST(413) = (GCARR(5.0E-11,0.0E+00,0.0))
  RCONST(414) = (GCARR(1.1E-11,0.0E+00,0.0))
  RCONST(415) = (GCARR(1.6E-11,0.0E+00,0.0))
  RCONST(416) = (GCARR(5.0E-11,0.0E+00,0.0))
  RCONST(417) = (GCARR(2.2E-11,0.0E+00,0.0))
  RCONST(418) = (GCARR(2.75E-11,0.0E+00,0.0))
  RCONST(419) = (GCARR(1.6E-16,0.0E+00,0.0))
  RCONST(420) = (GCARR(3.1E-11,0.0E+00,0.0))
  RCONST(421) = (GCARR(5.0E-11,0.0E+00,0.0))
  RCONST(422) = (GCARR(1.0E-17,0.0E+00,0.0))
  RCONST(423) = (GCARR(0.36E-12,0.0E+00,0.0))
  RCONST(424) = (GCARR(1.6E-27,0.0E+00,0.0))
  RCONST(425) = (GCARR(5.0E-11,0.0E+00,0.0))
  RCONST(426) = (GCARR(1.0E-17,0.0E+00,0.0))
  RCONST(427) = (GCARR(0.36E-12,0.0E+00,0.0))
  RCONST(428) = (GCARR(1.6E-27,0.0E+00,0.0))
  RCONST(429) = (GCARR(5.0E-11,0.0E+00,0.0))
  RCONST(430) = (GCARR(1.6E-27,0.0E+00,0.0))
  RCONST(431) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(432) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(433) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(434) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(435) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(436) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(437) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(438) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(439) = (GCARR(12.00E-18,0.0E+00,0.0))
  RCONST(440) = (GCARR(12.00E-18,0.0E+00,0.0))
  RCONST(441) = (GCARR(12.00E-18,0.0E+00,0.0))
  RCONST(442) = (GCARR(12.00E-18,0.0E+00,0.0))
  RCONST(443) = (GCARR(5.75E-18,0.0E+00,0.0))
  RCONST(444) = (GCARR(5.75E-18,0.0E+00,0.0))
  RCONST(445) = (GCARR(5.75E-18,0.0E+00,0.0))
  RCONST(446) = (GCARR(5.75E-18,0.0E+00,0.0))
  RCONST(447) = (GCARR(9.70E-18,0.0E+00,0.0))
  RCONST(448) = (GCARR(9.70E-18,0.0E+00,0.0))
  RCONST(449) = (GCARR(9.70E-18,0.0E+00,0.0))
  RCONST(450) = (GCARR(9.70E-18,0.0E+00,0.0))
  RCONST(451) = (GCARR(2.75E-18,0.0E+00,0.0))
  RCONST(452) = (GCARR(2.74E-18,0.0E+00,0.0))
  RCONST(453) = (GCARR(2.75E-18,0.0E+00,0.0))
  RCONST(454) = (GCARR(2.75E-18,0.0E+00,0.0))
  RCONST(455) = (GCARR(4.50E-18,0.0E+00,0.0))
  RCONST(456) = (GCARR(4.50E-18,0.0E+00,0.0))
  RCONST(457) = (GCARR(4.50E-18,0.0E+00,0.0))
  RCONST(458) = (GCARR(4.50E-18,0.0E+00,0.0))
  RCONST(459) = (GCARR(2.75E-18,0.0E+00,0.0))
  RCONST(460) = (GCARR(2.75E-18,0.0E+00,0.0))
  RCONST(461) = (GCARR(2.75E-18,0.0E+00,0.0))
  RCONST(462) = (GCARR(2.75E-18,0.0E+00,0.0))
  RCONST(463) = (GCARR(2.30E-18,0.0E+00,0.0))
  RCONST(464) = (GCARR(2.30E-18,0.0E+00,0.0))
  RCONST(465) = (GCARR(2.30E-18,0.0E+00,0.0))
  RCONST(466) = (GCARR(2.30E-18,0.0E+00,0.0))
  RCONST(467) = (GCARR(4.50E-18,0.0E+00,0.0))
  RCONST(468) = (GCARR(4.50E-18,0.0E+00,0.0))
  RCONST(469) = (GCARR(4.50E-18,0.0E+00,0.0))
  RCONST(470) = (GCARR(4.50E-18,0.0E+00,0.0))
  RCONST(471) = (GCARR(1.70E-18,0.0E+00,0.0))
  RCONST(472) = (GCARR(1.70E-18,0.0E+00,0.0))
  RCONST(473) = (GCARR(1.70E-18,0.0E+00,0.0))
  RCONST(474) = (GCARR(1.70E-18,0.0E+00,0.0))
  RCONST(475) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(476) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(477) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(478) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(479) = (GCARR(2.80E-18,0.0E+00,0.0))
  RCONST(480) = (GCARR(2.80E-18,0.0E+00,0.0))
  RCONST(481) = (GCARR(2.80E-18,0.0E+00,0.0))
  RCONST(482) = (GCARR(2.80E-18,0.0E+00,0.0))
  RCONST(483) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(484) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(485) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(486) = (GCARR(2.35E-18,0.0E+00,0.0))
  RCONST(487) = (GCARR(4.2E-18,0.0E+00,0.0))
  RCONST(488) = (GCARR(4.2E-18,0.0E+00,0.0))
  RCONST(489) = (GCARR(4.2E-18,0.0E+00,0.0))
  RCONST(490) = (GCARR(4.2E-18,0.0E+00,0.0))
  RCONST(491) = (GCARR(2.2E-18,0.0E+00,0.0))
  RCONST(492) = (GCARR(2.2E-18,0.0E+00,0.0))
  RCONST(493) = (GCARR(2.2E-18,0.0E+00,0.0))
  RCONST(494) = (GCARR(2.2E-18,0.0E+00,0.0))
  RCONST(495) = (GCARR(2.2E-18,0.0E+00,0.0))
  RCONST(496) = (GCARR(2.2E-18,0.0E+00,0.0))
  RCONST(497) = (GCARR(2.2E-18,0.0E+00,0.0))
  RCONST(498) = (GCARR(2.2E-18,0.0E+00,0.0))
  RCONST(499) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(500) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(501) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(502) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(503) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(504) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(505) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(506) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(507) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(508) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(509) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(510) = (GCARR(1.3E-13,0.0E+00,0.0))
  RCONST(511) = (PHOTOL(106))
  RCONST(512) = (PHOTOL(107))
  RCONST(513) = (PHOTOL(108))
  RCONST(514) = (PHOTOL(109))
  RCONST(515) = (PHOTOL(110))
  RCONST(516) = (PHOTOL(111))
  RCONST(517) = (PHOTOL(112))
  RCONST(518) = (PHOTOL(113))
  RCONST(519) = (PHOTOL(114))
